...
double q8sdot(int& n, FortranArray1DRef<double> a, int& idum1, FortranArray1DRef<double> b) {
    double q8sdot_result = 0.;
    for (int i = 1; i <= n; i++) {
        q8sdot_result = q8sdot_result + a(i) * b(i);
    }
    return q8sdot_result;
}
