...
void fa2xk(int& jf, int& kf, int& if_, FortranArray4DRef<double> qkf, int& js, int& ks, int& is, int& je, int& ke, int& ie, FortranArray1DRef<int> kbctyp, FortranArray1DRef<double> w, FortranArray1DRef<int> iw, int& nw, int& niw, int& neta, FortranArray1DRef<int> nou, FortranArray2DRef<char[120]> bou, int& nbuf, int& ibufdim);
