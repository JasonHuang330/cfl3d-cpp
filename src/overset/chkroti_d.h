...
void chkroti_d(int& nbl, int& jdim, int& kdim, int& idim, FortranArray3DRef<double> x, FortranArray3DRef<double> y, FortranArray3DRef<double> z, int& nblp, int& jdimp, int& kdimp, int& idimp, int& nface, FortranArray4DRef<double> bcdata, FortranArray3DRef<double> xyzip, int& ista, int& iend, int& jsta, int& jend, int& ksta, int& kend, int& mdim, int& ndim, int& lcnt, FortranArray1DRef<double> xorig, FortranArray1DRef<double> yorig, FortranArray1DRef<double> zorig, int& maxbl, FortranArray1DRef<double> period_miss, int& lbcprd, FortranArray1DRef<int> nou, FortranArray2DRef<char[120]> bou, int& nbuf, int& ibufdim, int& myid);
