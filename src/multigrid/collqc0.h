...
void collqc0(FortranArray4DRef<double> qc0, FortranArray4DRef<double> qc0c, FortranArray3DRef<double> vol, FortranArray3DRef<double> volc, int& jdim, int& kdim, int& idim, int& jj2, int& kk2, int& ii2, FortranArray4DRef<double> dqc0, FortranArray4DRef<double> dqc0c, FortranArray4DRef<double> qw, int& nbl, FortranArray1DRef<int> nou, FortranArray2DRef<char[120]> bou, int& nbuf, int& ibufdim);
