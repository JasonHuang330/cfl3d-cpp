...
void bcchk(int& idim, int& jdim, int& kdim, FortranArray4DRef<double> q, FortranArray4DRef<double> qi0, FortranArray4DRef<double> qj0, FortranArray4DRef<double> qk0, FortranArray3DRef<double> blank, int& ibcflg, int& nbl, FortranArray1DRef<int> nou, FortranArray2DRef<char[120]> bou, int& nbuf, int& ibufdim, int& myid, int& istop, FortranArray1DRef<int> igridg, int& maxbl);
