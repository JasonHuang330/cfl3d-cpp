...
void bc1013(int& jdim, int& kdim, int& idim,
            ...
            int& nummem)
{
    ...
    // ******************************************************************
    // j=1 boundary   extrapolation - singular axis   bctype 1013
    // ******************************************************************
    if (nface == 3) {
        for (int l = 1; l <= 5; l++) {
    ...
    // ******************************************************************
    // j=jdim boundary   extrapolation - singular axis   bctype 1013
    // ******************************************************************
    if (nface == 4) {
        for (int l = 1; l <= 5; l++) {
            for (int i = ista; i <= iend1; i++) {
    ...
    // ******************************************************************
    // k=1 boundary   extrapolation - singular axis   bctype 1013
    // ******************************************************************
    if (nface == 5) {
        for (int l = 1; l <= 5; l++) {
            for (int i = ista; i <= iend1; i++) {
    ...
    // ******************************************************************
    // k=kdim boundary   extrapolation - singular axis   bctype 1013
    // ******************************************************************
    if (nface == 6) {
        for (int l = 1; l <= 5; l++) {
            for (int i = ista; i <= iend1; i++) {
    ...
    // ******************************************************************
    // i=1 boundary   extrapolation - singular axis   bctype 1013
    // ******************************************************************
    if (nface == 1) {
        for (int l = 1; l <= 5; l++) {
            for (int k = ksta; k <= kend1; k++) {
    ...
    // ******************************************************************
    // i=idim boundary   extrapolation - singular axis   bctype 1013
    // ******************************************************************
    if (nface == 2) {
        for (int l = 1; l <= 5; l++) {
            for (int k = ksta; k <= kend1; k++) {
