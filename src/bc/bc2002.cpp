    ...
    for (int ibl = 1; ibl <= nbl; ibl++) {
        ...
        for (int iseg = 1; iseg <= nbcj0(ibl); iseg++) {
            if (jbcinfo(ibl,iseg,1,1) == 2002) {
                ...
                bc2002(jdim, kdim, idim, q, qj0, qk0, qi0, sj, sk, si,
...
void bc2002(int& jdim, int& kdim, int& idim,
            ...
            int& myid, int& nummem)
{
    ...
    int* ivisc       = cmn_reyue.ivisc;  // 0-based: [0]=ivisc(1), [1]=ivisc(2), [2]=ivisc(3)
    ...
    //******************************************************************************
    //      j=1 boundary        set pressure, extrapolate others         bctype 2002
    //******************************************************************************
    ...
    //******************************************************************************
    //      j=jdim boundary        set pressure, extrapolate others      bctype 2002
    //******************************************************************************
    ...
    //******************************************************************************
    //      k=1 boundary        set pressure, extrapolate others         bctype 2002
    //******************************************************************************
    ...
    //******************************************************************************
    //      k=kdim boundary        set pressure, extrapolate others      bctype 2002
    //******************************************************************************
    ...
    //******************************************************************************
    //      i=1 boundary        set pressure, extrapolate others         bctype 2002
    //******************************************************************************
    ...
    //******************************************************************************
    //      i=idim boundary        set pressure, extrapolate others      bctype 2002
    //******************************************************************************
